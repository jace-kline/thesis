...
\author{\IEEEauthorblockN{1\textsuperscript{st} Jace Kline}
\IEEEauthorblockA{\textit{Department of Electrical Engineering and Computer Science} \\
\textit{University of Kansas}\\
Lawrence, KS \\
jace\_kline@ku.edu}
\and
\IEEEauthorblockN{2\textsuperscript{nd} Dr. Prasad Kulkarni}
\IEEEauthorblockA{\textit{Department of Electrical Engineering and Computer Science} \\
\textit{University of Kansas}\\
Lawrence, KS \\
prasadk@ku.edu}
...
\end{itemize}
An excellent style manual for science writer.
